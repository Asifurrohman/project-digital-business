    ...
    <div class="container">
        ...
        <div class="ticket-card">
            ...
            <div class="ticket-body">
                ...
                @if(!empty($transaction->va_number))
                    <div class="grid" style="margin-bottom: 20px;">
                        <div class="grid-item" style="width: 100%; display: block;">
                            <p class="label">Nomor Virtual Account</p>
                            <p class="value" style="font-size: 18px;">{{ $transaction->va_number }}</p>
                        </div>
                    </div>
                @endif
            ...
            <div class="footer">
                ...
                <p style="margin-top: 10px;">&copy; {{ date('Y') }} Stile.</p>
            </div>
        </div>
    </div>
</body>
